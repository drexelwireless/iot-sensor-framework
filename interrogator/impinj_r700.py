...
class ImpinjR700(Interrogator):
    ...
    def start_server(self):
        ...
        toStart='default' #choose a mode to run in
        ...
        try:
            ...
            self.out('Error : Unable to connect to the Impinj Reader API on "{0}"'.format(hostname))
        ...
        requests.post(urljoin(hostname, 'api/v1/profiles/inventory/presets/{0}/start'.format(toStart))) # Start the default preset
    ...
    def handler_thread(self):
        while not self.exiting:
            ...
            input_msgs.append( input_msg.json() )
